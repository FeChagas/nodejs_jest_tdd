...
describe('Authentication', () => {
  ...
  it.each`
    language | message
    ${'br'}  | ${br.inactive_authentication_failure}
...
describe('Token Expiration', () => {
  ...
  it('refreshes lastUsedAt when unexpired token is used', async () => {
    ...
    expect(tokenInBD.lastUsedAt.getTime()).toBeGreaterThan(rightBeforeSendingRequest.getTime());
  });

  it('refreshes lastUsedAt when unexpired token is used for unauthenticaded endpoint', async () => {
    const savedUser = await addUser();
